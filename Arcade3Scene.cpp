...
void Batalla::setEnemy3Position(Point position)
{
    Point tileCoord = this->tileCoordForPosition(position);
    int tileGid = _blockage->getTileGIDAt(tileCoord);
    if (tileGid) {
...
bool Batalla::init()
{
    ...
    setPlayer1Position(ccp(x-50,y+150));
    ...
    addChild(_player2);
    //_player2->runAction(RotateBy::create(0.01, 90));
